...
// const bgColors = ['#202f45', '#1e2a3e', '#2a1e34', '#1b2e2d', '#2b2538']; // softer dreamlike tones

// export default function Echoes({ post, userEmail }) {
//   const ref = useRef();
...
//       className="break-inside-avoid rounded-2xl shadow-md hover:shadow-lg transition-all border border-white/10"
